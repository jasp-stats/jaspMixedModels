...
MixedModelsBLMM <- function(
   ...
   optionsWithFormula <- c("Contrasts", "dependentVariable", "fixedEffects", "fixedVariables", "marginalMeans", "plotLegendPosition", "plotsAgregatedOver", "plotsBackgroundColor", "plotsCImethod", "plotsGeom", "plotsPanel", "plotsTheme", "plotsTrace", "plotsX", "randomEffects", "randomVariables", "samplingPlot", "samplingVariable1", "samplingVariable2", "trendsContrasts", "trendsTrend", "trendsVariables")
